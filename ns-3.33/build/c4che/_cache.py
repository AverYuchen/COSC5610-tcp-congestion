...
CC = ['/usr/bin/gcc']
CCDEFINES = ['_DEBUG']
CCFLAGS = ['-O0', '-ggdb', '-g3', '-Wall', '-Wno-sign-compare', '-O0', '-ggdb', '-g3', '-Wall', '-Wno-sign-compare', '-std=c++11', '-fstrict-aliasing', '-Wstrict-aliasing']
...
CXX = ['/usr/bin/g++']
CXXDEFINES = ['_DEBUG']
CXXFLAGS = ['-O0', '-ggdb', '-g3', '-Wall', '-Wno-sign-compare', '-std=c++11', '-fstrict-aliasing', '-Wstrict-aliasing']
...
EXAMPLE_DIRECTORIES = ['matrix-topology', 'routing', 'traffic-control', 'stats', 'error-model', 'tcp', 'ipv6', 'udp', 'tutorial', 'energy', 'udp-client-server', 'channel-models', 'realtime', 'socket', 'naming', 'wireless']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/11', '/home/avery/Downloads/ns-allinone-3.33/ns-3.33/build/lib', '/home/avery/Downloads/ns-allinone-3.33/ns-3.33/build']
...
cfg_files = ['/home/avery/Downloads/ns-allinone-3.33/ns-3.33/build/ns3/config-store-config.h', '/home/avery/Downloads/ns-allinone-3.33/ns-3.33/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
